...
import com.paranoid.paranoidhub.activities.RequestFileActivity;
import com.paranoid.paranoidhub.activities.RequestFileActivity.RequestFileCallback;
...
public class InstallCard extends Card implements RequestFileCallback {
    ...
    public void fileRequested(String filePath) {
        if (filePath == null) {
            OTAUtils.showToastOnUiThread(getContext(), R.string.file_not_found);
        } else {
